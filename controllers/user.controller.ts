    ...
    try {
      await nylas.messages.send({
        ...
        requestBody: {
          ...
          body: `
          <p>Hi ${name},</p>
      <p>Your Ambu Ride verification code is ${otp}. If you didn't request for this OTP, please ignore this email!</p>
      <p>Thanks,<br>AmbuRide Team</p>
          `,
        },
      });
      res.status(201).json({
...
export const saveUserPushToken = async (req: any, res: Response) => {
  try {
